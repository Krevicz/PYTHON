...
label1 = Label(root, text="Hey use! Welcome to Denomination Counter Application.", bg = 'light blue')
...
def topwin():
    ...
    entry = Entry(top)
    lbl = Label(top, text="Here aer number of notes for each denomination", bg='light grey')
